...
class AccountRegisterPayments(models.TransientModel):
    ...
    transaction_type = fields.Selection([('pdc', 'Post Dated Check'), ('security', 'Security'), ('deposited', 'To Be Deposited')], string="Payment Type", default='pdc')
...
class AccountPayment(models.Model):
    ...
    cheque_reference = fields.Char(copy=False)
    effective_date = fields.Date('Effective Date', help='Effective date of PDC', copy=False, default=False)
    transaction_type = fields.Selection([('pdc', 'Post Dated Check'), ('security', 'Security'), ('deposited', 'To Be Deposited')], string="Payment Reason", default='pdc')
