...
class CustomReport(models.AbstractModel):
    _name="report.tfc_custom.custom_report"#Respect naming format report.module_name.report_template_name
    ...
    def _get_report_values(self, docids, data=None):
        ...
        for quant in quants :
            docs.append({
                ...
                'sale_qty': quant.sale_count,
                'purchase_qty' : quant.purchased_prodcut_quantity,
                ...
                'initial_qty': quant.qty_at_date - quant.sale_count
            })
    
        return {
            'doc_ids': data['ids'],
            'doc_model': self._name,#'create.custom.report', #model of the record
