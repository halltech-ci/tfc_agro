...
class ProductConversion(models.Model):
    ...
    src_product_tracking = fields.Selection('Tracking', related='src_product_id.tracking', readonly=True)
...
class ProductConversionLine(models.Model):
    ...
    dest_product_tracking = fields.Selection('Tracking', related='dest_product_id.tracking', readonly=True)
    allocate_quantity = fields.Float(string='Allocate Quantity', digits=dp.get_precision('Product Price'))
