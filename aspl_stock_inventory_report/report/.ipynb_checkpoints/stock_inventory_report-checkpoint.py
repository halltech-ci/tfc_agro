...
class aspl_stock_inventory_report(models.AbstractModel):
    _name = 'report.aspl_stock_inventory_report.stock_inv_template'
    _description = "report.aspl_stock_inventory_report.stock_inv_template"

    @api.model
    def _get_report_values(self, docids, data=None):
        report = self.env['ir.actions.report']._get_report_from_name('aspl_stock_inventory_report.stock_inv_template')
